...
public class BoardController {
	...
	@GetMapping("/get")
	public ModelAndView get(ModelAndView mv, Integer bno) throws Exception{ //jsp에서 controller로 데이터 전달
		System.out.println(bno);
		mv.addObject("boardVo", boardService.selectOne(bno));
	...
	public String insertDo(
	        RedirectAttributes redirectAttr, BoardVo vo) {
